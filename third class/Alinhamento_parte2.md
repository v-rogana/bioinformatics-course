...
1. [**Configuração do Ambiente**](#1-configuração-do-ambiente-com-micromamba)
2. [**Construção do Índice Bowtie**](#2-construção-do-índice-bowtie)
3. [**Alinhamento com Bowtie**](#3-alinhamento-com-bowtie)
4. [**Manipulação e Limpeza com Samtools**](#4-manipulação-e-limpeza-com-samtools)
